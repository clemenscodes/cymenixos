        ...
        hyprland = {
          ...
          settings = {
            ...
            bind = [
              ...
              (lib.mkIf useObs ", F8, pass, ^(com\.obsproject\.Studio)$")
              (lib.mkIf useObs ", F9, pass, ^(com\.obsproject\.Studio)$")
              (lib.mkIf useObs ", F10, pass, ^(com\.obsproject\.Studio)$")
              (lib.mkIf useObs ", F11, pass, ^(com\.obsproject\.Studio)$")
