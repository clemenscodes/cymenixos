        ...
        hyprland = {
          ...
          settings = {
            ...
            bind = [
              ...
              (lib.mkIf useObs "$mod, F8, pass, ^(com\.obsproject\.Studio)$")
              (lib.mkIf useObs "$mod, F9, pass, ^(com\.obsproject\.Studio)$")
              (lib.mkIf useObs "$mod, F10, pass, ^(com\.obsproject\.Studio)$")
              (lib.mkIf useObs "$mod, F11, pass, ^(com\.obsproject\.Studio)$")
