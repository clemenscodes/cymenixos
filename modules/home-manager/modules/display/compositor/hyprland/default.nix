        ...
        hyprland = {
          ...
          settings = {
            ...
            bind = [
              ...
              (lib.mkIf useObs "$mod, O, exec, obs")
              (lib.mkIf useObs "Shift Control, F8, pass, ^(com\.obsproject\.Studio)$")
              (lib.mkIf useObs "Shift Control, F9, pass, ^(com\.obsproject\.Studio)$")
              (lib.mkIf useObs "Shift Control, F10, pass, ^(com\.obsproject\.Studio)$")
              (lib.mkIf useObs "Shift Control, F11, pass, ^(com\.obsproject\.Studio)$")
