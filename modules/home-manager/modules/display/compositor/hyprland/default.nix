        ...
        hyprland = {
          ...
          settings = {
            ...
            bind = [
              ...
              (lib.mkIf useObs ", F8, pass,class:^(com\.obsproject\.Studio)$")
              (lib.mkIf useObs ", F9, pass,class:^(com\.obsproject\.Studio)$")
              (lib.mkIf useObs ", F10, pass,class:^(com\.obsproject\.Studio)$")
              (lib.mkIf useObs ", F11, pass,class:^(com\.obsproject\.Studio)$")
