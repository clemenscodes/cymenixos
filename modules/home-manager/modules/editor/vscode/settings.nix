        ...
        profiles = {
          default = {
            ...
            userSettings = {
              ...
              "chat.editor.fontFamily" = "Lilex Nerd Font";
              ...
              "editor.inlineSuggest.fontFamily" = "Lilex Nerd Font";
              "editor.inlayHints.fontFamily" = "Lilex Nerd Font";
              "editor.codeLensFontFamily" = "Lilex Nerd Font";
