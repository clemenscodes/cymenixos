            ...
            windowManager = {
              hyprland = {
                extraConfig = ''
                  ...
                  windowrule = size 1600 100%,class:(steam_app_.*),title:(W3Champions)
                  windowrule = size 1600 100%,class:(w3champions.exe),title:(W3Champions)
                  windowrule = center on,class:(steam_app_.*),title:(W3Champions)
                  windowrule = center on,class:(w3champions.exe),title:(W3Champions)
