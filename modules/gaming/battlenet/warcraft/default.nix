            ...
            windowManager = {
              hyprland = {
                ...
                in ''
                  ...
                  bind = , Control_L, sendshortcut, SPACE, title:^(Warcraft III)$
                  bind = , SPACE, sendshortcut, Control_L, title:^(Warcraft III)$
                  bind = , F1, sendshortcut, KP_7, title:^(Warcraft III)$
                  bind = SHIFT, F1, sendshortcut, SHIFT, KP_7, title:^(Warcraft III)$
                  bind = , F2, sendshortcut, KP_8, title:^(Warcraft III)$
                  bind = SHIFT, F2, sendshortcut, SHIFT, KP_8, title:^(Warcraft III)$
                  bind = , F3, sendshortcut, KP_4, title:^(Warcraft III)$
                  bind = SHIFT, F3, sendshortcut, SHIFT, KP_4, title:^(Warcraft III)$
                  bind = , F4, sendshortcut, KP_5, title:^(Warcraft III)$
                  bind = SHIFT, F4, sendshortcut, SHIFT, KP_5, title:^(Warcraft III)$
                  bind = , F5, sendshortcut, KP_1, title:^(Warcraft III)$
                  bind = SHIFT, F5, sendshortcut, SHIFT, KP_1, title:^(Warcraft III)$
                  bind = , F6, sendshortcut, KP_2, title:^(Warcraft III)$
                  bind = SHIFT, F6, sendshortcut, SHIFT, KP_2, title:^(Warcraft III)$
