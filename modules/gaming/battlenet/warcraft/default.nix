            ...
            windowManager = {
              hyprland = {
                ...
                in ''
                  ...
                  bind = , F1, sendshortcut, , KP_7, class:steam_app_default, fullscreen:1
                  bind = SHIFT, F1, sendshortcut, SHIFT, KP_7, class:steam_app_default, fullscreen:1
                  bind = , F2, sendshortcut, , KP_8, class:steam_app_default, fullscreen:1
                  bind = SHIFT, F2, sendshortcut, SHIFT, KP_8, class:steam_app_default, fullscreen:1
                  bind = , F3, sendshortcut, , KP_4, class:steam_app_default, fullscreen:1
                  bind = SHIFT, F3, sendshortcut, SHIFT, KP_4,class:steam_app_default, fullscreen:1
                  bind = , F4, sendshortcut, , KP_5, class:steam_app_default, fullscreen:1
                  bind = SHIFT, F4, sendshortcut, SHIFT, KP_5, class:steam_app_default, fullscreen:1
                  bind = , F5, sendshortcut, , KP_1, class:steam_app_default, fullscreen:1
                  bind = SHIFT, F5, sendshortcut, SHIFT, KP_1, class:steam_app_default, fullscreen:1
                  bind = , F6, sendshortcut, , KP_2, class:steam_app_default, fullscreen:1
                  bind = SHIFT, F6, sendshortcut, SHIFT, KP_2, class:steam_app_default, fullscreen:1
